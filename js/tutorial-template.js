...
templates['tutorial-template'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<h2>"
    ...
    + ((stack1 = container.invokePartial(partials.shortcuts,depth0,{"name":"shortcuts","data":data,"indent":"                        ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "        \n                  </ul>\n                </nav>\n            </div>\n         </div>\n";
